...
I am a Multiplatform (DAM) and Web Applications (DAW) developer who treats software engineering like a discipline. I build end-to-end architectures—from configuring the AWS cloud infrastructure to coding the native Android client and orchestrating local AI workflows. 
...
*   **AI Integration:** Groq, Gemini APIs, Ollama, RAG pipelines.




<!--
**SebasValero22/SebasValero22** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
